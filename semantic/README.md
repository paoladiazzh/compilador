...
El analizador semántico es la tercera fase del compilador. Recibe el **Abstract Syntax Tree (AST)** generado por el parser y realiza validaciones semánticas sobre el código fuente, asegurando que cumpla con las reglas del lenguaje más allá de la sintaxis.
